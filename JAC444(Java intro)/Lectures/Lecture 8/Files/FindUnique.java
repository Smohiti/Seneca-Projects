...
//Set unique contains all elements (unique), but when a duplicate element is found, it is added to dups set
//uniques.removeAll(dups); will remove from uniques all the elements that are duplicate. 
//Therefore uniques contains only unique elements from the initial input
